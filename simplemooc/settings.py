...
SECRET_KEY = 'ci$fnw=zirwhlzqd@vyqk(jrm#u$1bt0#-+nng^ki3z6-gv2q('
...
MEDIA_ROOT = os.path.join(BASE_DIR,'simplemooc','media') #Variavel de imagem
MEDIA_URL = '/media/'

#E-mails
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
#EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
DEFAULT_FROM_EMAIL = 'Priscila <prisciladanielem@gmail.com>'
EMAIL_USE_TLS = True
